...
const Button = ({ onClick, text, variant }) => {
  const buttonStyles = {
    ...
    complete: "align-middle select-none transition-all py-2 px-4 disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xl shadow-md shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none rounded-full relative",
    cancel: "align-middle select-none font-sans font-bold py-3 px-8 text-center uppercase transition-all bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full",
